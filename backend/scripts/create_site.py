...
from pos.interfaces import IBrowserLayer
...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-pos:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-pos:initial")
        transaction.commit()
    app._p_jar.sync()
