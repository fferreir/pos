...
DEPLOY_ENV=prod
DEPLOY_HOST=posepidemiovps.fmvz.usp.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for posepidemiovps.fmvz.usp.br, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    posepidemiovps.fmvz.usp.br:
      ansible_user: root
      host: posepidemiovps
      hostname: posepidemiovps.fmvz.usp.br
```
...
Deploy the stack defined in `devops/stacks/posepidemiovps.fmvz.usp.br.yml` to the remote server with:
